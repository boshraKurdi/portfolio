          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <motion.a variants={fadeIn('down' , 0.6)} initial="hidden" whileInView={'show'} viewport={{once: false ,amount: 0.7}} className="a" href="https://linkedin.com/in/boshrakurdi-0637452a0/" onClick={(event)=>{handleOpenNewTab(event ,'linkedin.com/in/boshrakurdi-0637452a0/')}}><Linkedin /></motion.a>
